...
st.markdown("""
    ...
    @keyframes pulseGlow {
        0%, 100% { box-shadow: 0 3px 8px rgba(30,136,229,0.35); }
        50% { box-shadow: 0 3px 16px rgba(0,172,193,0.55); }
    }
    ...
    /* Tab con (Đơn Đặt Mới / Tồn / Đã Nhập Kho) - kiểu pill nhỏ nhẹ nhàng hơn */
    div[data-testid="stTabs"] div[data-testid="stTabs"] div[role="tablist"] button[role="tab"] {
    ...
    /* Đường kẻ phân cách nhẹ nhàng thay cho <br> đơn điệu */
    .soft-divider {
        height: 1px;
